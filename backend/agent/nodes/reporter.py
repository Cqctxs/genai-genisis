...
async def _generate_benchmark_details(
    ...
    async def _process_bench(bench: dict) -> BenchmarkDetail | None:
        ...
        return BenchmarkDetail(
            ...
            before_time_ms=comparison.old_time_ms,
            before_memory_mb=comparison.old_memory_mb,
            after_time_ms=comparison.new_time_ms,
            after_memory_mb=comparison.new_memory_mb,
