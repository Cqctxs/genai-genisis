...
const FAKE_GRAPH_DATA: GraphData = {
  nodes: [
    {
      id: "main", label: "Main Entrypoint", file: "app.py", node_type: "function",
      inputs: { records_path: "str", config_path: "str" },
      outputs: { report: "FormattedReport" },
      avg_time_ms: 12.4, memory_mb: 1.2, severity: "low", position_x: 300, position_y: 0,
    },
    {
      id: "load_config", label: "Load Configuration", file: "config.py", node_type: "function",
      inputs: { config_path: "str" },
      outputs: { config: "dict" },
      avg_time_ms: 3.1, memory_mb: 0.5, severity: "low", position_x: 0, position_y: 180,
    },
    {
      id: "fetch_remote", label: "Fetch Remote Data", file: "pipeline.py", node_type: "api",
      metadata: { method: "GET", endpoint: "/api/v2/records" },
      inputs: { api_key: "str", page: "int" },
      outputs: { records: "list[dict]" },
      avg_time_ms: 320.5, memory_mb: 12.4, severity: "high", position_x: 300, position_y: 180,
    },
    {
      id: "cache_check", label: "Cache Hit?", file: "pipeline.py", node_type: "condition",
      metadata: { condition: "record_hash in cache" },
      avg_time_ms: 0.8, memory_mb: 0.1, severity: "low", position_x: 300, position_y: 360,
    },
    {
      id: "query_orders", label: "Query Orders Table", file: "db.py", node_type: "db",
      metadata: { table: "orders", operation: "SELECT" },
      inputs: { user_id: "int", date_range: "tuple" },
      outputs: { rows: "list[OrderRow]" },
      avg_time_ms: 234.1, memory_mb: 64.3, severity: "critical", position_x: 600, position_y: 360,
    },
    {
      id: "process_batch", label: "Process Batch", file: "pipeline.py", node_type: "function",
      inputs: { records: "list[dict]", batch_size: "int" },
      outputs: { processed: "list[dict]" },
      avg_time_ms: 142.3, memory_mb: 48.7, severity: "critical", position_x: 0, position_y: 360,
    },
    {
      id: "analyze_sentiment", label: "Analyze Sentiment", file: "ai.py", node_type: "llm",
      metadata: { model: "gemini-3-flash", purpose: "Classify record sentiment" },
      inputs: { text: "str" },
      outputs: { sentiment: "str", confidence: "float" },
      avg_time_ms: 890.2, memory_mb: 2.1, severity: "high", position_x: 0, position_y: 540,
    },
    {
      id: "aggregate_metrics", label: "Aggregate Metrics", file: "metrics.py", node_type: "function",
      inputs: { processed: "list[dict]" },
      outputs: { summary: "dict" },
      avg_time_ms: 87.6, memory_mb: 22.1, severity: "medium", position_x: 300, position_y: 540,
    },
    {
      id: "format_report", label: "Format Report", file: "report.py", node_type: "function",
      inputs: { summary: "dict", orders: "list" },
      outputs: { report: "FormattedReport" },
      avg_time_ms: 5.8, memory_mb: 1.8, severity: "low", position_x: 300, position_y: 720,
    },
  ],
  edges: [
    { source: "main", target: "load_config", label: "init", edge_type: "call" },
    { source: "main", target: "fetch_remote", label: "", edge_type: "call" },
    { source: "fetch_remote", target: "cache_check", label: "", edge_type: "call" },
    { source: "cache_check", target: "process_batch", label: "cache hit", edge_type: "branch_true" },
    { source: "cache_check", target: "query_orders", label: "cache miss", edge_type: "branch_false" },
    { source: "query_orders", target: "aggregate_metrics", label: "", edge_type: "call" },
    { source: "process_batch", target: "analyze_sentiment", label: "", edge_type: "call" },
    { source: "analyze_sentiment", target: "process_batch", label: "for each record", edge_type: "loop_back" },
    { source: "process_batch", target: "aggregate_metrics", label: "", edge_type: "call" },
    { source: "aggregate_metrics", target: "format_report", label: "", edge_type: "call" },
  ],
};
